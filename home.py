...
with col1:
    ...
    st.write("We've created a machine learning model (Random Forest Regression) that estimates an expected proxy sea ice thickness based on ice charts generated by the Canadian Ice Service. The Random Forest Regression is trained on observed CryoSat-2 sea ice thickness.")
