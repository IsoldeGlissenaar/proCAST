...
st.write("A scientific paper about the proxy SIT product and it's validation and first results is under review and a preprint is available [here](https://egusphere.copernicus.org/preprints/2023/egusphere-2023-269/). Check out the [latest ice conditions](https://canadian-sit.streamlit.app/latest).")
